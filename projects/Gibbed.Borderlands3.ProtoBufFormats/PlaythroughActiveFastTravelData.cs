...
{
    [ProtoContract]
    public class PlaythroughActiveFastTravelData : INotifyPropertyChanged
    {
        #region Fields
        private List<ActiveFastTravelData> _ActiveTravelStations;
        #endregion

        #region Properties
        [ProtoMember(1, IsRequired = true)]
        public List<ActiveFastTravelData> ActiveTravelStations
        {
